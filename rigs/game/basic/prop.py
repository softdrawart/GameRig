...
class Rig(BaseRig, BoneUtilityMixin):
    ...
    def generate_bones(self):
        ...
        if self.make_deformer:
            org = self.bones.org
            self.bones.deform = def_bone = self.copy_bone(org, make_derived_name(org, 'def'), parent=True)
...
def create_sample(obj):
    ...
    pbone.rigify_type = 'vizor.basic.prop'
    pbone.rigify_parameters['make_controller'] = 0
